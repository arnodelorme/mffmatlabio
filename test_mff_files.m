...
inputFilenames = { ...
    ...
    ...
    'Net Station Files from EGI/OtherFilesJoe/SLI_30.ave.mff' ...
    'Net Station Files from EGI/OtherFilesJoe/EEG-fMRI_seg_1.mff' ...
    'Net Station Files from EGI/OtherFilesJoe/1001_fil_bcr_ref_seg.mff' ...
    };
...
for iFile = length(datasetsToLoad)-4 %datasetsToLoad %datasetsToLoad %1 %[20 23] %1:length(datasetsToLoad)
    errorMsg = '';
